...
Route::group(['middleware'=>'isVerif'],function(){
	...
	Route::group(['middleware'=>'isAdmin'],function(){
		...
		Route::get('/cup/admin/user','HomeController@user_data')->name('user_manage');
		Route::get('/cup/admin/user/add','HomeController@user_add')->name('user_add');
		Route::get('/cup/admin/user/delete/{id_user}','HomeController@user_delete')->name('user_delete');
		Route::post('/cup/admin/user/add','HomeController@user_add_act')->name('user_add_act');
		Route::get('/cup/admin/user/{id_user}','HomeController@user_manage')->name('user_manage_data');
