...
@endsection
@section('content')
<section class="dashboard-lomba" style="background-color: #E7E7E7; min-height: 100%;">
		<div class="container">
...
@endphp
	...
	@else
		@if($status == "nunggu")
										<div class="btn btn-info btn-curve btn-status disabled" style="cursor: default;" >Menuggu Validasi Pembayaran</div>
		
		@else
										<div class="btn btn-danger btn-curve btn-status disabled" style="cursor: default;" >Segera Lakukan Pembayaran</div>
